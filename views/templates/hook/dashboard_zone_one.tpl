		...
		<header>
			<i class="icon-AdminNimble"></i> {l s='Pagos con Nimble Payments' mod='nimblepayment'}
                ...
                {else}
                    <ul class="data_list">
                            <li>
                                    <span class="data_label">{l s='Total' mod='nimblepayment'}</a></span>
                                    <span class="data_value size_sm">
                                            <span id="">{*$data['total']|escape:'htmlall':'UTF-8'*}</span>
                                    </span>
                            </li>
                            <li>
                                    <span class="data_label">{l s='Last 7 days' mod='nimblepayment'}</a></span>
                                    <span class="data_value size_sm">
                                    </span>
                            </li>
                            <li>
                                    <span class="data_label">{l s='Last 30 days' mod='nimblepayment'}</a></span>
                                    <span class="data_value size_sm">
                                    </span>
                            </li>
                    </ul>
